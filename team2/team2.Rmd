---
title: "Bringing Bus Stops and Pantries Closer"
output: 
  html_document:
    self_contained: yes
    lib_dir: libs
...
pantry <- read.csv("C:/zol/Data4Good/pantries.csv",sep=",",header=T, stringsAsFactors = FALSE)
...
bus_stop <- readRDS("C:/zol/Data4Good/busstops.rds")
